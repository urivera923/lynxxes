<?php 
    ...
    $sql = "SELECT descripcion, fecha
            FROM t_videos WHERE id_video='$id'";
            ...
            <div class="col">
                ...
                <div class="card my-5 mx-5 shadow border">
                    ...
                    <div class="card-body">
                        ...
                        <form action="../Crud/procesos_video/actualizarVideo.php" method="post">
                        ...
                        <button class="btn btn-danger mt-4 mb-2" onclick="window.location.href='../Crud/index_videos.php'"><i class="fa-solid fa-ban mx-2"></i>Cancelar</button>
                    </div>
                </div>
